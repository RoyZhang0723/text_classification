...
print(model.wv)
# 选出最相似的10个词
for e in model.wv.most_similar(positive=['乔峰'], topn=100):
   print(e[0], e[1])
...
for i in list3:
    for j in list3:
        print(model.wv.similarity(i,j))
print(model.wv.doesnt_match(list3))

# 查看词的向量值
print(type(model.wv['乔峰']))  # 输出 <class 'numpy.ndarray'>
print(len(model.wv['乔峰']))  # 输出 100
print(model.wv['乔峰'])  # 输出 一行100列的向量 [-0.64503133  0.7794444 ...]